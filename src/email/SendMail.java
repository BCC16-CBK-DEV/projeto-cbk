...
import cbk.principal.loginController;
...
public class SendMail {
	...
	public void sendMail(String from, String to, String subject, String message) {
		...
		auth = new SimpleAuth (loginController.loginTela.email_remetente,loginController.loginTela.senha_email);
		...
		try {
			 ...
			 */
			tr.connect(mailSMTPServer, loginController.loginTela.email_remetente, loginController.loginTela.senha_email);
