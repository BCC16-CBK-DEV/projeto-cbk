...
-- Copiando dados para a tabela cbk_database.cliente: 5 rows
...
-- Copiando dados para a tabela cbk_database.ordem_servico: 6 rows
...
INSERT INTO `ordem_servico` (`id_ordem`, `numero_ordem`, `nota_fiscal`, `data_compra`, `defeito_reclamado`, `codigo_produto`, `descricao_produto`, `voltagem`, `numero_serie_produto`, `data_abertura`, `id_status`, `id_cliente`) VALUES
	(1, '0001', '321321312', '2018-02-26', 'teste', '12312321', 'teste', 123, 'tste', '2018-05-22', 1, 1),
	(2, '0002', '1312321', '2018-02-26', 'teste 2', '1232', 'teste1', 122, '3423423434324', '2018-05-22', 1, 1),
	(3, '0002', '3123123', '2018-01-29', 'DDFSDFDF', '23213', 'ASDASDA', 323, 'SADSDSADAS', '2018-05-22', 1, 2),
	(4, '0002', '244324', '2018-04-29', 'teste', '123', 'steete', 233, '3424234344', '2018-05-22', 1, 2),
	(5, '0002', '32432', '2018-04-29', 'tetes', '23234', 'tstetss', 324, 'teses', '2018-05-22', 1, 1),
	(6, '0002', '147502', '2018-05-24', 'NÃO FUNCIONA', 'MTC6615', 'DVD AUTOMOTIVO ', 127, '0001', '2018-05-23', 1, 1);
...
-- Copiando dados para a tabela cbk_database.pedido_peca: 0 rows
...
INSERT INTO `usuario` (`id_usuario`, `nome_usuario`, `senha`, `id_departamento`) VALUES
	(1, 'admin', '123', 1),
	(3, 'igorcasconi', 'igor12', 1),
	(10, 'garbielviado', 'EUSOUGAY', 2);
